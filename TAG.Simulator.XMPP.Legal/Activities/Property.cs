...
namespace TAG.Simulator.XMPP.Legal.Activities
{
	...
	public class Property : ActivityNode
	{
		...
		public Property(ISimulationNode Parent, Model Model)
			: base(Parent, Model)
		{
		}
		...
		{
			return new Property(Parent, Model);
		}
		...
		{
			if (this.Parent is ApplyLegalId ApplyLegalId)
				ApplyLegalId.Register(this);
		...
		public async Task<Waher.Networking.XMPP.Contracts.Property> Evaluate(Variables Variables)
		{
