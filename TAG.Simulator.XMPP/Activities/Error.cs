...
namespace TAG.Simulator.XMPP.Activities
{
	...
	/// </summary>
	public class Error : ActivityNode, IValueRecipient
	{
		...
		public Error(ISimulationNode Parent, Model Model)
			: base(Parent, Model)
		{
		}
		...
		public override void ExportPlantUml(StreamWriter Output, int Indentation, char QuoteChar)
		{
			...
			Output.AppendUmlArgument(Indentation, "Id", this.requestId.Value, true, QuoteChar, ref First);
