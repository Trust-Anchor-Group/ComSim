...
namespace TAG.Simulator.XMPP.Activities
{
	...
	/// </summary>
	public class UnsubscribeFrom : ActivityNode
	{
		...
		public UnsubscribeFrom(ISimulationNode Parent, Model Model)
			: base(Parent, Model)
		{
		}
		...
		/// </summary>
		public override string LocalName => nameof(UnsubscribeFrom);
		...
		{
			return new UnsubscribeFrom(Parent, Model);
		}
