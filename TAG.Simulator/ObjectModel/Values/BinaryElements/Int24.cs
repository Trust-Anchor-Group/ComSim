...
namespace TAG.Simulator.ObjectModel.Values.BinaryElements
{
	...
	/// Int24 value.
	/// </summary>
	public class Int24 : SimulationNode, IBinaryElement
	{
		...
		public Int24(ISimulationNode Parent, Model Model)
			: base(Parent, Model)
		{
		}
		...
		/// </summary>
		public override string LocalName => "Int24";
		...
		public void Append(MemoryStream Output, Variables Variables)
		{
			...
			Output.Write(BitConverter.GetBytes(this.value ?? 
				((Result = this.script.Evaluate(Variables)) is System.Int32 Value ? Value :
