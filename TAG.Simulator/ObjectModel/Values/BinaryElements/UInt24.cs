...
namespace TAG.Simulator.ObjectModel.Values.BinaryElements
{
	...
	/// UInt24 value.
	/// </summary>
	public class UInt24 : SimulationNode, IBinaryElement
	{
		...
		public UInt24(ISimulationNode Parent, Model Model)
			: base(Parent, Model)
		{
		}
		...
		/// </summary>
		public override string LocalName => "UInt24";
		...
		{
			return new UInt24(Parent, Model);
		}
		...
		public void Append(MemoryStream Output, Variables Variables)
		{
			...
			Output.Write(BitConverter.GetBytes(this.value ?? 
				((Result = this.script.Evaluate(Variables)) is System.UInt32 Value ? Value :
				Convert.ToUInt32(Result))), 0, 3);
		}
