...
namespace TAG.Simulator.ObjectModel.Values
{
	...
	public class Script : Value
	{
		...
		/// </summary>
		public override string LocalName => nameof(Script);
		...
		{
			return this.expression.EvaluateAsync(Variables);
		}
		...
		{
			Eval.ExportPlantUml(this.script, Output, Indentation, QuoteChar, false);
		}
	}
}
