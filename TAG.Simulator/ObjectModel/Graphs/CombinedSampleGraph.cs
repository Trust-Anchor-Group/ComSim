namespace TAG.Simulator.ObjectModel.Graphs
{
	...
	/// </summary>
	public class CombinedSampleGraph : CombinedGraph
	{
		/// <summary>
		/// Combines sample graphs
		/// </summary>
		...
		/// </summary>
		public override string LocalName => nameof(CombinedSampleGraph);
		...
		{
			if (this.Model.TryGetSampleGraph(Reference, out IGraph Graph))
				return Graph;
			else
				return null;
		}
		...
		public override void Register(ISource Source)
		{
			...
			this.Model.RegisterCustomSampleGraph(Source.Reference, this);
		}
	}
}
