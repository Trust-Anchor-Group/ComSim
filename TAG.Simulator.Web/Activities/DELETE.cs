...
namespace TAG.Simulator.Web.Activities
{
	...
	public class DELETE(ISimulationNode Parent, Model Model)
		: WebCall(Parent, Model)
	{
		...
		/// </summary>
		public override string LocalName => nameof(DELETE);
		...
		{
			return new DELETE(Parent, Model);
		}
		...
		{
			return Client.DELETE(Url, Timeout, Headers);
		}
	}
}
