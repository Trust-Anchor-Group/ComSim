...
namespace TAG.Simulator.Web.Activities
{
	...
	public class PATCH(ISimulationNode Parent, Model Model)
		: WebCall(Parent, Model)
	{
		...
		/// </summary>
		public override string LocalName => nameof(PATCH);
		...
		{
			return Client.PATCH(Url, Content, Timeout, Headers);
		}
	}
}
