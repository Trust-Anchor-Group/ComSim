...
namespace TAG.Simulator.Web.Activities
{
	...
	public class HEAD(ISimulationNode Parent, Model Model)
		: WebCall(Parent, Model)
	{
		/// <summary>
		/// Local name of XML element defining contents of class.
		/// </summary>
		public override string LocalName => nameof(HEAD);
		...
		{
			return Client.HEAD(Url, Timeout, Headers);
		}
	}
}
