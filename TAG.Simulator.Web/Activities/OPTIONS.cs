...
namespace TAG.Simulator.Web.Activities
{
	...
	public class OPTIONS(ISimulationNode Parent, Model Model)
		: WebCall(Parent, Model)
	{
		...
		/// </summary>
		public override string LocalName => nameof(OPTIONS);
		...
		{
			return new OPTIONS(Parent, Model);
		}
		...
		{
			return Client.OPTIONS(Url, Timeout, Headers);
		}
	}
}
