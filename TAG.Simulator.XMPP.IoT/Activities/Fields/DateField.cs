...
namespace TAG.Simulator.XMPP.IoT.Activities.Fields
{
	...
	public class DateField : FieldNode
	{
		...
		public override void AddFields(List<Field> Fields, Variables Variables)
		{
			...
			Fields.Add(new Waher.Things.SensorData.DateField(this.ThingReference, DateTime.Now, this.Name, TypedValue.Date, this.Type, this.QualityOfService, this.Writable));
		}
