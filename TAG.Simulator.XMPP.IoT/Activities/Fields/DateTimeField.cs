...
namespace TAG.Simulator.XMPP.IoT.Activities.Fields
{
	...
	public class DateTimeField : FieldNode
	{
		...
		/// </summary>
		public override string LocalName => "DateTimeField";
		...
		public override void AddFields(List<Field> Fields, Variables Variables)
		{
			...
			Fields.Add(new Waher.Things.SensorData.DateTimeField(this.ThingReference, DateTime.Now, this.Name, TypedValue, this.Type, this.QualityOfService, this.Writable));
		}
