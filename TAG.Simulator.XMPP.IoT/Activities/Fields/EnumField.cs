...
namespace TAG.Simulator.XMPP.IoT.Activities.Fields
{
	...
	public class EnumField : FieldNode
	{
		...
		/// </summary>
		public override string LocalName => nameof(EnumField);
		...
		public override async Task AddFields(LinkedList<Field> Fields, Variables Variables)
		{
			...
			Fields.AddLast(new Waher.Things.SensorData.EnumField(this.ThingReference, DateTime.Now, this.Name, TypedValue, this.Type, this.QualityOfService, this.Writable));
		}
