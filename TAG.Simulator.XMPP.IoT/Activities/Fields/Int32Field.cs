...
namespace TAG.Simulator.XMPP.IoT.Activities.Fields
{
	...
	public class Int32Field : FieldNode
	{
		...
		/// </summary>
		public override string LocalName => "Int32Field";
		...
		public override void AddFields(List<Field> Fields, Variables Variables)
		{
			...
			Fields.Add(new Waher.Things.SensorData.Int32Field(this.ThingReference, DateTime.Now, this.Name, TypedValue, this.Type, this.QualityOfService, this.Writable));
		}
